...
CREATE TABLE `impersonation_logs` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_impersonation_logs_impersonated_user` (`impersonated_user_id`),
  INDEX `fk_impersonation_logs_impersonator` (`impersonator_id`),
  ...
  CONSTRAINT `fk_impersonation_logs_impersonator` FOREIGN KEY (`impersonator_id`) REFERENCES `users` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
